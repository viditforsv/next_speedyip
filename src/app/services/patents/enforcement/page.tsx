...
import { Target, Check, Shield, Users, Award, FileText, ArrowLeft, Zap, Building2 } from 'lucide-react';
...
const processSteps = [
  {
    ...
    description: 'Deep prior art analysis for competitive advantage',
    icon: <FileText className="h-6 w-6" />
  },
  {
    step: '2',
    title: 'Strategic Drafting',
    description: 'Broad claims with multiple embodiments',
    icon: <Shield className="h-6 w-6" />
  },
  {
    step: '3',
    title: 'Robust Filing',
    description: 'Comprehensive USPTO submission',
    icon: <Award className="h-6 w-6" />
  },
  {
    step: '4',
    title: 'Breadth Protection',
    description: 'Strategic office action responses',
    icon: <Target className="h-6 w-6" />
  }
];

const pricingBreakdown = [
  { stage: 'Novelty Search', price: '₹30,000' },
  { stage: 'Provisional Specification', price: '₹35,000' },
  { stage: 'Complete Specification', price: '₹1,15,000' },
  { stage: 'FER Response', price: '₹55,000' },
  { stage: 'Hearing & Submissions', price: '₹60,000' },
  { stage: 'Final Disposal', price: 'Included' }
];

export default function EnforcementPatentsPage() {
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: '#e3f2fd' }}>
                  <Target className="h-6 w-6" style={{ color: '#0066B2' }} />
                </div>
                <div>
              ...
              <p className="text-xl mb-8" style={{ color: '#6c757d' }}>
                Ideal for established companies and manufacturers who need strong, enforceable patent rights for competitive 
                advantage, licensing opportunities, and market protection. Build defensible IP assets.
              </p>
            ...
            <div className="flex justify-center">
              <div className="w-32 h-32 rounded-full flex items-center justify-center" style={{ backgroundColor: '#e3f2fd' }}>
                <Target className="h-16 w-16" style={{ color: '#0066B2' }} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg" style={{ color: '#6c757d' }}>
              Established businesses needing competitive protection
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {['Established Companies', 'Manufacturers', 'Licensing Businesses'].map((customer, index) => (
      ...
      <section className="py-20 px-4" style={{ backgroundColor: '#f8f9fa' }}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg" style={{ color: '#6c757d' }}>
              What makes our Enforcement Patent approach powerful
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {enforcementFeatures.map((feature, index) => (
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg" style={{ color: '#6c757d' }}>
              Stage-wise professional fees for Enforcement Patents
            </p>
          </div>
            ...
            <Card style={{ backgroundColor: '#FFFFFF', borderColor: '#e5e5e5' }}>
              <CardHeader>
                <CardTitle className="text-center text-2xl" style={{ color: '#333333' }}>
                  Enforcement Patent Pricing
                </CardTitle>
                <p className="text-center" style={{ color: '#6c757d' }}>
                  Total: ₹2,95,000 - ₹3,50,000 (excluding government fees)
                </p>
              </CardHeader>
              <CardContent>
                ...
                <div className="mt-6 p-4 rounded-lg" style={{ backgroundColor: '#e3f2fd' }}>
                  <p className="text-sm text-center" style={{ color: '#6c757d' }}>
                    <strong>Note:</strong> Government fees and taxes are additional. Higher investment for stronger protection and licensing potential.
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4" style={{ color: '#333333' }}>
              Why Choose Enforcement Patents?
            </h2>
            <p className="text-lg" style={{ color: '#6c757d' }}>
              Strategic advantages for competitive businesses
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center p-6" style={{ backgroundColor: '#FFFFFF', borderColor: '#e5e5e5' }}>
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: '#e3f2fd' }}>
                <Shield className="h-8 w-8" style={{ color: '#0066B2' }} />
              </div>
              <h3 className="text-xl font-semibold mb-3" style={{ color: '#333333' }}>Competitive Shield</h3>
              <p style={{ color: '#6c757d' }}>
                Deter competitors with broad, defensible claims that minimize workarounds
              </p>
            </Card>
            ...
            <Card className="text-center p-6" style={{ backgroundColor: '#FFFFFF', borderColor: '#e5e5e5' }}>
              ...
              <h3 className="text-xl font-semibold mb-3" style={{ color: '#333333' }}>Licensing Revenue</h3>
              <p style={{ color: '#6c757d' }}>
                Enable licensing opportunities with strong, enforceable patent rights
              </p>
            </Card>
            ...
            <Card className="text-center p-6" style={{ backgroundColor: '#FFFFFF', borderColor: '#e5e5e5' }}>
              ...
              <h3 className="text-xl font-semibold mb-3" style={{ color: '#333333' }}>Market Position</h3>
              <p style={{ color: '#6c757d' }}>
                Strengthen your market position with comprehensive patent protection
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-16 px-4" style={{ backgroundColor: '#f8f9fa' }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6" style={{ color: '#333333' }}>
            Build Defensible Patent Assets
          </h2>
          <p className="text-lg mb-8" style={{ color: '#6c757d' }}>
            Invest in strong patent protection for competitive advantage and licensing opportunities.
          </p>
